...
|---|---|---|---|---|---|---|
| 1 | **SCCR (live)** | 0.347 · 140 blocks · 99.29% below 1× · **N=26,586 (measured reachable validating nodes)** · T=10yr · spec 2.1.1 | Observed fee + measured N | `data/sccr.json` | 2026-09-17 | B |
